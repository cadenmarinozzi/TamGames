import createWaflashModule from './waflash.min.js';
							...
							if (s >= 0) {
								...
								if ('.swf' == o) {
									if (
										...
										return (
											'https://swfs.waflash.io/uploads/hangame/' +
											n
										);
									if (
										'http://img.ibravo.com/game/source/' ==
										a
									)
										return (
											'https://darkviky.github.io/assets/ibravo/' +
											n
										);
									if (
										'http://www.ibravo.com/web/game/popup/signed.aspx' ==
										t
									)
										return 'https://darkviky.github.io/assets/ibravo/web/game/popup/signed.aspx';
									if (
										t.lastIndexOf(
											'/ads/default/loading.swf'
										) >= 0
									)
								...
								if (
									t.lastIndexOf('/loading/result2_v3_2.swf') >
									0
								)
								...
								if (
									((e =
										'http://www.zuzunza.com/all/check_id.php'),
									t.startsWith(e))
								)
									return (
										'https://ieazco9902.execute-api.ap-northeast-2.amazonaws.com/zuzunza/all/check_id' +
								...
								if (
									((e =
										'http://kidsdaum.zuzunza.com/all/check_id.php'),
									t.startsWith(e))
								)
									return (
										'https://ieazco9902.execute-api.ap-northeast-2.amazonaws.com/zuzunza/all/check_id' +
								...
								if (
									'.mp3' == o &&
									'http://juter01.tistory.com/attachment/' ==
										a
								)
									return (
										'https://darkviky.github.io/assets/gog/' +
										n
									);
								if (
								...
								if (
									t.startsWith('https://pororo.jr.naver.com/')
								)
									return (
										'https://swfs.waflash.io/uploads/pororo/waf/' +
										n
									);
